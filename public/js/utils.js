 ...
 */
export function animateTokenMovement(tokenElement, fromIndex, toIndex, totalCells, radius, duration = 800) {
  ...
  tokenElement.style.transform = `translate(calc(-50% + ${toPos.x}px), calc(-50% + ${toPos.y}px))`;
