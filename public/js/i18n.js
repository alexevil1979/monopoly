...
/** Текст карты Chance/Community Chest по id (ch1, cc1, …); fallback — ключ или переданный text */
export function getCardText(cardId, fallbackText = '') {
  if (!cardId) return fallbackText;
  const key = `card_${cardId}`;
  const val = t(key);
  return val === key ? fallbackText : val;
}
...
const translations = {
  en: {
    ...
    tax_modal_hint: 'Pay $200 or 10% of total assets.',
    utility_modal_hint: 'Rent: 4× dice (one utility) or 10× (both).',
    railroad_modal_hint: 'Rent: $25 / $50 / $100 / $200 (by number of railroads owned).',
    card_ch1: 'Advance to Go. Collect $200.',
    card_ch2: 'Bank pays you dividend of $200.',
    card_ch3: 'Go to Jail. Do not pass Go.',
    card_ch4: 'Pay poor tax of $100.',
    card_ch5: 'You have won a crossword competition. Collect $100.',
    card_ch6: 'Get out of Jail Free (hold until needed).',
    card_cc1: 'Advance to Go. Collect $200.',
    card_cc2: 'Bank error in your favor. Collect $200.',
    card_cc3: 'Go to Jail. Do not pass Go.',
    card_cc4: 'Doctor\'s fees. Pay $100.',
    card_cc5: 'From sale of stock you get $50.',
    card_cc6: 'Holiday fund matures. Receive $100.',
  ...
  ru: {
    ...
    price: 'Цена',
    rent: 'Аренда',
    no_purchase: 'Покупки нет. Следуйте правилу клетки.',
    tax_modal_hint: 'Заплатите $200 или 10% от активов.',
    utility_modal_hint: 'Аренда: 4× кубики (одна) или 10× (обе).',
    railroad_modal_hint: 'Аренда: $25 / $50 / $100 / $200 (по числу ж/д).',
    card_ch1: 'Перейдите на «Старт». Получите $200.',
    card_ch2: 'Банк выплачивает вам дивиденды $200.',
    card_ch3: 'Отправляйтесь в тюрьму. Не проходите «Старт».',
    card_ch4: 'Заплатите налог для бедных $100.',
    card_ch5: 'Вы выиграли конкурс кроссвордов. Получите $100.',
    card_ch6: 'Выход из тюрьмы бесплатно (сохраните до надобности).',
    card_cc1: 'Перейдите на «Старт». Получите $200.',
    card_cc2: 'Ошибка банка в вашу пользу. Получите $200.',
    card_cc3: 'Отправляйтесь в тюрьму. Не проходите «Старт».',
    card_cc4: 'Врачебный счёт. Заплатите $100.',
    card_cc5: 'От продажи акций вы получаете $50.',
    card_cc6: 'Фонд отпусков созрел. Получите $100.',
  ...
  zh: {
    ...
    price: '价格',
    rent: '租金',
    no_purchase: '无需购买。按格子规则执行。',
    tax_modal_hint: '支付 $200 或总资产 10%。',
    utility_modal_hint: '租金：4×骰子（一个）或 10×（两个）。',
    railroad_modal_hint: '租金：$25 / $50 / $100 / $200（按拥有铁路数）。',
    card_ch1: '前进到起点。获得 $200。',
    card_ch2: '银行支付股息 $200。',
    card_ch3: '入狱。不经过起点。',
    card_ch4: '缴纳贫民税 $100。',
    card_ch5: '您赢得填字比赛。获得 $100。',
    card_ch6: '免狱卡（保留至需要时使用）。',
    card_cc1: '前进到起点。获得 $200。',
    card_cc2: '银行对您有利的差错。获得 $200。',
    card_cc3: '入狱。不经过起点。',
    card_cc4: '医生费。支付 $100。',
    card_cc5: '出售股票获得 $50。',
    card_cc6: '度假基金到期。获得 $100。',
    reconnect: '重新连接...',
    theme_toggle: '切换主题',
  ...
  hi: {
    ...
    price: 'कीमत',
    rent: 'किराया',
    no_purchase: 'कोई खरीद नहीं। सेल नियम का पालन करें।',
    tax_modal_hint: '$200 या कुल संपत्ति का 10% दें।',
    utility_modal_hint: 'किराया: 4× पासा (एक) या 10× (दोनों)।',
    railroad_modal_hint: 'किराया: $25 / $50 / $100 / $200 (रेलरोड की संख्या)।',
    card_ch1: 'गो पर जाएं। $200 लें।',
    card_ch2: 'बैंक आपको लाभांश $200 देता है।',
    card_ch3: 'जेल जाएं। गो मत लें।',
    card_ch4: 'गरीब कर $100 दें।',
    card_ch5: 'आपने क्रॉसवर्ड जीता। $100 लें।',
    card_ch6: 'जेल से मुक्त निकलें (जरूरत तक रखें)।',
    card_cc1: 'गो पर जाएं। $200 लें।',
    card_cc2: 'बैंक की गलती आपके पक्ष में। $200 लें।',
    card_cc3: 'जेल जाएं। गो मत लें।',
    card_cc4: 'डॉक्टर की फीस। $100 दें।',
    card_cc5: 'स्टॉक बिक्री से $50 मिले।',
    card_cc6: 'छुट्टी फंड मैच्योर। $100 लें।',
  ...
  ar: {
    ...
    price: 'السعر',
    rent: 'الإيجار',
    no_purchase: 'لا شراء. اتبع قاعدة الخانة.',
    tax_modal_hint: 'ادفع $200 أو 10% من إجمالي الأصول.',
    utility_modal_hint: 'إيجار: 4× النرد (واحدة) أو 10× (كلتاهما).',
    railroad_modal_hint: 'إيجار: $25 / $50 / $100 / $200 (حسب عدد السكك).',
    card_ch1: 'تقدم إلى الانطلاق. احصل على $200.',
    card_ch2: 'البنك يدفع لك أرباحاً $200.',
    card_ch3: 'اذهب إلى السجن. لا تمر بالانطلاق.',
    card_ch4: 'ادفع ضريبة الفقراء $100.',
    card_ch5: 'فزت بمسابقة كلمات متقاطعة. احصل على $100.',
    card_ch6: 'خروج مجاني من السجن (احتفظ حتى الحاجة).',
    card_cc1: 'تقدم إلى الانطلاق. احصل على $200.',
    card_cc2: 'خطأ بنكي لصالحك. احصل على $200.',
    card_cc3: 'اذهب إلى السجن. لا تمر بالانطلاق.',
    card_cc4: 'رسوم الطبيب. ادفع $100.',
    card_cc5: 'من بيع الأسهم تحصل على $50.',
    card_cc6: 'صندوق العطل نضج. احصل على $100.',
